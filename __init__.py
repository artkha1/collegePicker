...
def create_app():
    ...
    #TODO: change all of this to 'secret' when uploading
    app.config['SECRET_KEY'] =  'secret' # it is used by Flask and extensions to keep data safe. Generated using os.urandom(24).hex()
    params = urllib.parse.quote_plus(
    'Driver={ODBC Driver 17 for SQL Server};'+
    'Server=tcp:aneyeonschoolserver.database.windows.net,1433;'+
    'Database=aneyeon_school;'+
    'Uid=secret;' +
    'Pwd=secret;' +
    'Encrypt=yes;' +
    'TrustServerCertificate=no;' +
    'Connection Timeout=30;')
    app.config['SQLALCHEMY_DATABASE_URI'] = "mssql+pyodbc:///?odbc_connect=%s" % params #it is the path where the MSSQL database will be saved
